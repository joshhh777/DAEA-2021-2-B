...
namespace lab15.Models
{
    ...
    public partial class SchoolEntities : DbContext
    {
        ...
        public virtual ObjectResult<BuscarCurso_Result> BuscarCurso(string nameCourse)
        {
            var nameCourseParameter = nameCourse != null ?
                new ObjectParameter("NameCourse", nameCourse) :
                new ObjectParameter("NameCourse", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<BuscarCurso_Result>("BuscarCurso", nameCourseParameter);
        }
    
        public virtual ObjectResult<BuscarPersona_Result> BuscarPersona(string firstName, string lastName, string personID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<BuscarPersona_Result>("BuscarPersona", firstNameParameter, lastNameParameter, personIDParameter);
        }
        ...
        public virtual ObjectResult<BuscarPersonaID_Result> BuscarPersonaID(string personID)
        {
            var personIDParameter = personID != null ?
                new ObjectParameter("personID", personID) :
                new ObjectParameter("personID", typeof(string));
